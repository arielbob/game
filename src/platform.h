...
bool32 platform_open_file(char *filename, Platform_File *file_result, bool32 *is_in_use=NULL);
...
File_Data platform_open_and_read_file(Allocator *allocator, char *filename, bool32 *is_in_use = NULL);
File_Data platform_open_and_read_file(Allocator *allocator, String filename, bool32 *is_in_use = NULL);
